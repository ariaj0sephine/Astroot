      ...
      bottomNavigationBar: SizedBox(
        ...
        child: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Icons.camera_alt_outlined, size: 30), selectedIcon: Icon(Icons.camera_alt, size: 30), label: ''),
...
// Tabs (fixed the color typo here!)
  ...
  Widget build(BuildContext context) => Stack(
    children: [
      BackdropFilter(
        ...
        child: Container(color: const Color(0xFF00145C).withOpacity(0.15)), // ← was 0xFF00145 → crash!
      ),
      const Center(
        child: Padding(
...
class CameraTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const Center(
    child: Text('Camera Tab: Point & Identify\n(Add camera here next week!)',
